...
export default function LinkAnalyzer({ token }) {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!detectedPlatform) {
      setError('URL platform not supported. Please paste a link from YouTube, Instagram, LinkedIn, or Facebook.');
      return;
    }
  ...
  const getPlatformIcon = (platform) => {
    switch (platform) {
      ...
      case 'Facebook':
        return <span style={{ color: '#1877f2' }}>📘 Facebook</span>;
      default:
        ...
        <form className="analyzer-form" onSubmit={handleSubmit}>
          <div className="input-wrapper">
            <input 
              ...
              placeholder="Paste YouTube, Instagram, LinkedIn, or Facebook content URL here..."
              value={url}
